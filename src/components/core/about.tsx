...
const About = () => {
  const triggerClasses =
    'text-md text-muted-foreground hover:no-underline hover:text-primary transition-colors duration-100 scroll-m-20 font-semibold tracking-tight';
            ...
            <List
              items={[
                ...
                <>
                  ...
                  <InlineCode>
                    <Icons.down className="inline-block h-3 w-3" />
                  </InlineCode>{' '}
