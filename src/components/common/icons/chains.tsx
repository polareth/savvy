...
// Icons for all chains supported by the app
// - Arbitrum
// - Ethereum
// - Optimism
// - Polygon
...
export const ArbitrumIcon = (props: LucideProps) => (
  <svg
...
/* -------------------------------- ETHEREUM -------------------------------- */
// From https://tokenlistooor.com/
export const EthereumIcon = (props: LucideProps) => (
  <svg
    width="32"
    height="32"
    viewBox="0 0 32 32"
  ...
  >
    <g fill="none" fillRule="evenodd">
      <path
        fill="#62688F"
        d="M32,16 C32,13.90592 31.58336,11.81184 30.78208,9.87712 C29.9808,7.9424 28.79456,6.16704 27.3136,4.6864 C25.83296,3.20544 24.0576,2.0192 22.12288,1.21792 C20.18816,0.41664 18.09408,0 16,0 C13.90592,0 11.81184,0.41664 9.87712,1.21792 C7.9424,2.0192 6.16704,3.20544 4.6864,4.6864 C3.20544,6.16704 2.0192,7.9424 1.21792,9.87712 C0.41664,11.81184 0,13.90592 0,16 C0,18.09408 0.41664,20.18816 1.21792,22.12288 C2.0192,24.0576 3.20544,25.83296 4.6864,27.3136 C6.16704,28.79456 7.9424,29.9808 9.87712,30.78208 C11.81184,31.58336 13.90592,32 16,32 C18.09408,32 20.18816,31.58336 22.12288,30.78208 C24.0576,29.9808 25.83296,28.79456 27.3136,27.3136 C28.79456,25.83296 29.9808,24.0576 30.78208,22.12288 C31.58336,20.18816 32,18.09408 32,16 Z"
      />
      <g fill="#FFF" transform="translate(9.333 4.667)">
        <polygon points="6.854 0 0 11.262 6.854 15.274 13.71 11.262" />
        <polygon points="0 12.55 6.854 22.114 13.714 12.55 6.854 16.56" />
      </g>
    </g>
  </svg>
);
...
/* -------------------------------- OPTIMISM -------------------------------- */
// From https://tokenlistooor.com/
export const OptimismIcon = (props: LucideProps) => (
  <svg
    width="32"
    height="32"
    viewBox="0 0 128 128"
  ...
  >
    <g clipPath="url(#clip0_66_7)">
      ...
      />
      <path
        d="M45.3461 81.0101C41.5352 81.0101 38.4131 80.1134 35.9793 78.3201C33.5775 76.4948 32.3766 73.901 32.3766 70.5385C32.3766 69.834 32.4567 68.9692 32.6167 67.9444C33.0332 65.6389 33.6256 62.8687 34.3941 59.6344C36.5717 50.828 42.1919 46.4248 51.2545 46.4248C53.7203 46.4248 55.9299 46.8411 57.8834 47.6736C59.8369 48.4741 61.374 49.6911 62.4947 51.3244C63.6155 52.9254 64.1761 54.8469 64.1761 57.0885C64.1761 57.761 64.096 58.6096 63.9358 59.6344C63.4555 62.4845 62.879 65.2546 62.2065 67.9444C61.0857 72.3317 59.1483 75.6142 56.3943 77.7917C53.6402 79.9372 49.9576 81.0101 45.3461 81.0101ZM46.0186 74.093C47.8121 74.093 49.333 73.5646 50.582 72.5079C51.8631 71.4511 52.7757 69.834 53.3199 67.6564C54.0565 64.6461 54.6171 62.0201 55.0014 59.7785C55.1294 59.106 55.1934 58.4176 55.1934 57.7129C55.1934 54.7988 53.6722 53.3417 50.6302 53.3417C48.8366 53.3417 47.2996 53.8701 46.0186 54.9268C44.7698 55.9838 43.873 57.601 43.3288 59.7785C42.7523 61.9241 42.1758 64.5501 41.5995 67.6564C41.4712 68.2967 41.4072 68.9692 41.4072 69.6737C41.4072 72.62 42.9445 74.093 46.0186 74.093Z"
        fill="white"
      />
      <path
        d="M66.3815 80.5299C66.0293 80.5299 65.7569 80.4177 65.5649 80.1935C65.4046 79.9372 65.3568 79.6492 65.4208 79.329L72.0496 48.1059C72.1136 47.7537 72.2897 47.4654 72.578 47.2412C72.8663 47.0172 73.1704 46.905 73.4906 46.905H86.2681C89.8227 46.905 92.6727 47.6415 94.8183 49.1146C96.9961 50.5878 98.0848 52.7173 98.0848 55.5033C98.0848 56.3038 97.9888 57.1366 97.7966 58.0011C96.9961 61.6839 95.3789 64.406 92.9451 66.1672C90.5433 67.9285 87.2448 68.8092 83.0497 68.8092H76.5649L74.3554 79.329C74.2912 79.6812 74.115 79.9692 73.827 80.1935C73.5388 80.4177 73.2344 80.5299 72.9144 80.5299H66.3815ZM83.3861 62.1803C84.7308 62.1803 85.8997 61.8119 86.8925 61.0754C87.9173 60.3389 88.5898 59.2821 88.91 57.9051C89.006 57.3606 89.0542 56.8803 89.0542 56.4641C89.0542 55.5353 88.782 54.8308 88.2375 54.3505C87.693 53.838 86.7645 53.582 85.4515 53.582H79.6871L77.8618 62.1803H83.3861Z"
        fill="white"
      />
    </g>
    <defs>
...
/* -------------------------------- POLYGON -------------------------------- */
// From https://tokenlistooor.com/
export const PolygonIcon = (props: LucideProps) => (
  <svg
    width="32"
    height="32"
    viewBox="0 0 32 32"
  ...
  >
    ...
    />
    <path
      d="M21.2959 12.5769C20.9122 12.3537 20.4133 12.3537 19.9911 12.5769L16.9978 14.2886L14.9638 15.4048L11.9704 17.1165C11.5867 17.3397 11.0878 17.3397 10.6657 17.1165L8.28631 15.7769C7.90257 15.5537 7.63393 15.1444 7.63393 14.6979V12.056C7.63393 11.6095 7.86417 11.2002 8.28631 10.9769L10.6273 9.67462C11.011 9.45136 11.5099 9.45136 11.9321 9.67462L14.273 10.9769C14.6568 11.2002 14.9254 11.6095 14.9254 12.056V13.7676L16.9594 12.6141V10.9025C16.9594 10.456 16.7291 10.0467 16.307 9.82345L11.9704 7.36764C11.5867 7.14438 11.0878 7.14438 10.6657 7.36764L6.25236 9.82345C5.83025 10.0467 5.59998 10.456 5.59998 10.9025V15.8514C5.59998 16.2979 5.83025 16.7072 6.25236 16.9304L10.6657 19.3862C11.0494 19.6095 11.5483 19.6095 11.9704 19.3862L14.9638 17.7118L16.9978 16.5583L19.9911 14.8839C20.3749 14.6607 20.8738 14.6607 21.2959 14.8839L23.6369 16.1862C24.0206 16.4095 24.2893 16.8188 24.2893 17.2653V19.9072C24.2893 20.3537 24.059 20.763 23.6369 20.9862L21.2959 22.3258C20.9122 22.549 20.4133 22.549 19.9911 22.3258L17.6502 21.0235C17.2664 20.8002 16.9978 20.3909 16.9978 19.9444V18.2327L14.9638 19.3862V21.0979C14.9638 21.5444 15.1941 21.9537 15.6162 22.1769L20.0295 24.6327C20.4133 24.856 20.9122 24.856 21.3343 24.6327L25.7476 22.1769C26.1313 21.9537 26.4 21.5444 26.4 21.0979V16.149C26.4 15.7025 26.1697 15.2932 25.7476 15.0699L21.2959 12.5769Z"
      fill="white"
    />
  </svg>
);
...
export const BaseIcon = (props: LucideProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    ...
    <g id="Layer_x0020_1">
      ...
      <g
        style={{
          clipPath:
            'url(#SVGID_00000137130877621503601290000017679510272143242652_)',
        }}
      >
        <path
...
/* ---------------------------------- ZORA ---------------------------------- */
export const ZoraIcon = (props: LucideProps) => (
  <svg
    width="32"
    height="32"
    viewBox="0 0 305 305"
  ...
  >
    ...
    >
      <path
        d="M152.405 304.81C236.576 304.81 304.81 236.576 304.81 152.405C304.81 68.2341 236.576 0 152.405 0C68.2341 0 0 68.2341 0 152.405C0 236.576 68.2341 304.81 152.405 304.81Z"
        fill="#D9D9D9"
      />
    </mask>
    <g mask="url(#mask0_438_1437)">
      <path
        d="M356.46 -66.2583H-47.0312V337.233H356.46V-66.2583Z"
        fill="#A1723A"
      />
      <g filter="url(#filter0_f_438_1437)">
        <path
          d="M164.045 298.402C253.865 298.402 326.677 225.61 326.677 135.818C326.677 46.0249 253.865 -26.7666 164.045 -26.7666C74.2266 -26.7666 1.41406 46.0249 1.41406 135.818C1.41406 225.61 74.2266 298.402 164.045 298.402Z"
          fill="#531002"
        />
      </g>
      <g filter="url(#filter1_f_438_1437)">
        <path
          d="M181.575 246.94C254.424 246.94 313.481 187.863 313.481 114.988C313.481 42.1122 254.424 -16.9648 181.575 -16.9648C108.726 -16.9648 49.6699 42.1122 49.6699 114.988C49.6699 187.863 108.726 246.94 181.575 246.94Z"
          fill="#2B5DF0"
        />
      </g>
      <g filter="url(#filter2_f_438_1437)">
        <path
          d="M179.172 254.48C255.119 254.48 316.686 192.892 316.686 116.92C316.686 40.9472 255.119 -20.6406 179.172 -20.6406C103.226 -20.6406 41.6592 40.9472 41.6592 116.92C41.6592 192.892 103.226 254.48 179.172 254.48Z"
          fill="url(#paint0_radial_438_1437)"
        />
      </g>
      <g filter="url(#filter3_f_438_1437)">
        <path
          d="M201.981 151.558C240.241 151.558 271.256 120.543 271.256 82.2833C271.256 44.0238 240.241 13.0083 201.981 13.0083C163.721 13.0083 132.706 44.0238 132.706 82.2833C132.706 120.543 163.721 151.558 201.981 151.558Z"
          fill="#FCB8D4"
        />
      </g>
      <g filter="url(#filter4_f_438_1437)">
        <path
          d="M201.934 109.899C217.213 109.899 229.597 97.5143 229.597 82.2361C229.597 66.9583 217.213 54.5732 201.934 54.5732C186.656 54.5732 174.271 66.9583 174.271 82.2361C174.271 97.5143 186.656 109.899 201.934 109.899Z"
          fill="white"
        />
      </g>
      <g filter="url(#filter5_f_438_1437)">
        <path
          d="M183.556 358.44C320.848 358.44 432.145 247.143 432.145 109.851C432.145 -27.4407 320.848 -138.738 183.556 -138.738C46.2639 -138.738 -65.0332 -27.4407 -65.0332 109.851C-65.0332 247.143 46.2639 358.44 183.556 358.44Z"
          fill="url(#paint1_radial_438_1437)"
          fillOpacity={0.9}
        />
      </g>
    </g>
    <defs>
      ...
      >
        ...
        />
        <feGaussianBlur
          stdDeviation={18.8503}
          result="effect1_foregroundBlur_438_1437"
        />
      </filter>
      <filter
        id="filter1_f_438_1437"
        x={-25.7315}
        y={-92.3662}
        width={414.613}
        height={414.708}
      ...
      >
        ...
        />
        <feGaussianBlur
          stdDeviation={37.7007}
          result="effect1_foregroundBlur_438_1437"
        />
      </filter>
      <filter
        id="filter2_f_438_1437"
        x={13.3837}
        y={-48.9161}
        width={331.577}
        height={331.672}
      ...
      >
        ...
        />
        <feGaussianBlur
          stdDeviation={14.1378}
          result="effect1_foregroundBlur_438_1437"
        />
      </filter>
      <filter
        id="filter3_f_438_1437"
        x={76.155}
        y={-43.5427}
        width={251.652}
        height={251.652}
      ...
      >
        ...
        />
        <feGaussianBlur
          stdDeviation={28.2755}
          result="effect1_foregroundBlur_438_1437"
        />
      </filter>
      <filter
        id="filter4_f_438_1437"
        x={136.571}
        y={16.8726}
        width={130.728}
        height={130.727}
      ...
      <radialGradient
        id="paint0_radial_438_1437"
        cx={0}
        cy={0}
        r={1}
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(202.367 78.1114) rotate(128.228) scale(259.71 259.689)"
      >
        <stop offset={0.286458} stopColor="#387AFA" />
        <stop offset={0.647782} stopColor="#387AFA" stopOpacity={0} />
      </radialGradient>
      <radialGradient
        id="paint1_radial_438_1437"
        cx={0}
        cy={0}
        r={1}
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(183.556 109.851) rotate(90) scale(248.589)"
      >
